...
! function(e) {
    ...
    ! function(e, t) {
        kendo.ui.FlatColorPicker && (kendo.ui.FlatColorPicker.prototype.options.messages = e.extend(!0, kendo.ui.FlatColorPicker.prototype.options.messages, {
        	...
        	sortAscending: "ზრდადობით",//"Sort Ascending",
        	sortDescending: "კლებადობით",//"Sort Descending",
        	filter: "გაფილტვრა",//"Filter",
            ...
            dialogUpdate: "განახლება",
            dialogInsert: "დამატება",
            dialogButtonSeparator: "ან",
        	...
        	info: "ჩანაწერები ამ მნიშვნელობით:",//"Show items with value that:",
            isTrue: "კი",//"is true",
            isFalse: "არა",//"is false",
            filter: "გაფილტვრა",//"Filter",
            clear: "გასუფთავება",//"Clear",
            and: "და",//"And",
            or: "ან",//"Or",
            selectValue: "-აირჩიეთ მნიშვნელობა-",//"-Select value-",
            operator: "Operator",
            value: "Value",
            cancel: "Cancel"
            ...
            string: {
            	eq: "ტოლია",//"Is equal to",
            	neq: "არ უდრის",//"Is not equal to",
            	startswith: "იწყება",//"Starts with",
            	contains: "შეიცავს",//"Contains",
            	doesnotcontain: "არ შეიცავს",//"Does not contain",
            	endswith: "მთავრდება"//"Ends with"
            },
            number: {
            	eq: "ტოლია",//"Is equal to",
            	neq: "არ უდრის",//"Is not equal to",
            	gte: "მეტია ან ტოლია",//"Is greater than or equal to",
            	gt: "მეტია",//"Is greater than",
            	lte: "ნაკლებია ან ტოლია",//"Is less than or equal to",
            	lt: "ნაკლებია"//"Is less than"
            },
            date: {
            	eq: "ტოლია",//"Is equal to",
            	neq: "არ უდრის",//"Is not equal to",
            	gte: "მეტია ან ტოლია",//"Is after or equal to",
            	gt: "მეტია",//"Is after",
            	lte: "ნაკლებია ან ტოლია",//"Is before or equal to",
            	lt: "ნაკლებია"//"Is before"
            },
            enums: {
            	eq: "ტოლია",//"Is equal to",
            	neq: "არ უდრის"//"Is not equal to"
            ...
            commands: {
                cancel: "ცვლილებების გაუქმება",//"Cancel changes",
                canceledit: "გაუქმება",
                create: "ახალი ჩანაწერის დამატება",
                destroy: "წაშლა",
                edit: "რედაქტირება",
                excel: "ექსელში ექსპორტი",//"Export to Excel",
                pdf: "PDF ფორმატში ექსპორტი",//"Export to PDF",
                save: "ცვლილებების შენახვა",//"Save changes",
                select: "აირჩიეთ",//"Select",
                update: "განახლება"//"Update"
            },
            editable: {
            	cancelDelete: "გაუქმება",//"Cancel",
            	confirmation: "დარწმუნებული ხართ რომ გსურთ ამ ჩანაწერის წაშლა?",//"Are you sure you want to delete this record?",
                confirmDelete: "წაშლა"//"Delete"
            },
            noRecords: "ჩანაწერი არ არის."//"No records available."
        	...
        	empty: "ცარიელია",//"Drag a column header and drop it here to group by that column"
        })), kendo.ui.NumericTextBox && (kendo.ui.NumericTextBox.prototype.options = e.extend(!0, kendo.ui.NumericTextBox.prototype.options, {
        	upArrowText: "მნიშვნელობის გაზრდა",//"Increase value",
        	downArrowText: "მნიშვნელობის შემცირება"//"Decrease value"
        })), kendo.ui.Pager && (kendo.ui.Pager.prototype.options.messages = e.extend(!0, kendo.ui.Pager.prototype.options.messages, {
        	allPages: "ყველა",//"All",
        	display: "გამოტანილია {0} - {1} ჩანაწერი {2} ჩანაწერიდან",//"{0} - {1} of {2} items",
        	empty: "ჩანაწერი არ არის",//"No items to display",
        	page: "გვერდი",//"Page",
        	of: "ის {0}",//"of {0}",
        	itemsPerPage: "ჩანაწერი ერთ გვერდზე",//"items per page",
        	first: "პირველ გვერდზე გადასვლა",//"Go to the first page",
        	previous: "წინა გვერდზე გადასვლა",//"Go to the previous page",
        	next: "შემდეგ გვერდზე გადასვლა",//"Go to the next page",
        	last: "ბოლო გვერდზე გადასვლა",//"Go to the last page",
        	...
        	required: "{0} სავალდებულოა",//"{0} is required",
        	pattern: "{0} არ არის სწორი",//"{0} is not valid",
        	min: "{0} უნდა იყოს მეტი ან ტოლი {1} - ზე",//"{0} should be greater than or equal to {1}",
        	max: "{0} უნდა იყოს ნაკლები ან ტოლი {1} - ზე",//"{0} should be smaller than or equal to {1}",
        	step: "{0} არ არის სწორი",//"{0} is not valid",
        	email: "{0} ელ-ფოსტა არასწორია",//"{0} is not valid email",
        	url: "{0} URL არასწორია",//"{0} is not valid URL",
        	date: "{0} თარიღი არასწორია",//"{0} is not valid date",
